...
export function AdminControls() {
  ...
  const submit = async (e: FormEvent<HTMLFormElement>, route: string) => {
    ...
    await fetchJSON(route, { method: "POST", body: JSON.stringify(payload) });
  ...
  return (
    <section className="space-y-4">
      ...
      <form className="card p-4 space-y-2" onSubmit={(e) => submit(e, "/api/captains")}>
      ...
      <form className="card p-4 space-y-2" onSubmit={(e) => submit(e, "/api/players")}>
      ...
      <form className="card p-4 space-y-2" onSubmit={(e) => submit(e, "/api/teams")}>
      ...
      <form className="card p-4 space-y-2" onSubmit={(e) => submit(e, "/api/announcements")}>
